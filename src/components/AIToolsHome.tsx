...
export function AIToolsHome({ onNavigate }: AIToolsHomeProps) {
  ...
  const categories = [
    { id: 'video', name: 'AI Video Tools', icon: Video, color: 'bg-black', count: 24 },
    { id: 'image', name: 'AI Image Tools', icon: Image, color: 'bg-yellow-500', count: 32 },
    { id: 'writing', name: 'AI Writing Tools', icon: PenTool, color: 'bg-black', count: 18 },
    { id: 'code', name: 'AI Code Tools', icon: Code, color: 'bg-yellow-500', count: 15 },
    { id: 'chatbot', name: 'AI Chatbots', icon: MessageCircle, color: 'bg-black', count: 12 },
    { id: 'business', name: 'AI Business Tools', icon: Briefcase, color: 'bg-yellow-500', count: 28 }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="mb-8">
            ...
            <h1 className="text-4xl lg:text-7xl mb-6">
              Find & Compare the Best <span className="text-yellow-500">AI Tools</span>
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Button 
              size="lg" 
              className="bg-black hover:bg-gray-800 text-white px-8 py-4 rounded-lg text-lg transition-all duration-300"
            ...
            <Button 
              size="lg" 
              className="bg-yellow-500 hover:bg-yellow-600 text-black px-8 py-4 rounded-lg text-lg transition-all duration-300"
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="px-8 py-4 rounded-lg text-lg border-2 border-gray-300 hover:bg-gray-50 transition-all duration-300"
              onClick={submitTool}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
            <div className="text-center">
              <div className="text-3xl mb-2 text-black">120+</div>
              <div className="text-gray-600">AI Tools Listed</div>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-2 text-yellow-500">50K+</div>
              <div className="text-gray-600">Monthly Users</div>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-2 text-black">4.8★</div>
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex gap-2 mb-4">
                          ...
                          <Button 
                            ...
                            className={selectedTools.includes(tool.id) ? 'bg-yellow-50 border-yellow-500 text-yellow-600' : ''}
                          >
