...
import { MinimalSocialIcons } from './SocialIcons';
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-400 text-sm">
                Get the latest design resources, AI tools, and inspiration delivered weekly.
              </p>
              <p className="text-gray-500 text-xs mt-1">
                Join 50,000+ designers. Unsubscribe at any time.
              </p>
            </div>
            <form onSubmit={handleNewsletterSubmit} className="flex gap-3 min-w-0 md:min-w-80">
              <input
                type="email"
              ...
              <Button 
                type="submit"
                disabled={isSubscribing}
                className="bg-yellow-500 hover:bg-yellow-600 disabled:opacity-50 disabled:cursor-not-allowed text-black flex-shrink-0"
              >
